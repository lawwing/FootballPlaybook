// package cn.lawwing.lawwingnormalsdk.utils;
//
...
// public static final String CREATE_TABLE_IF_NOT_EXISTS = "create table if not
// exists %s " +
...
// Cursor cursor = mSQLiteDatabase.query(table, null, null, null, null, null,
// "id asc");
// //最多缓存200条
// if (cursor.getCount() > 200 && cursor.moveToNext()) {
// mSQLiteDatabase.delete(table, "id=?", new
// String[]{String.valueOf(cursor.getInt
...
// return (mSQLiteDatabase.insertWithOnConflict(table, null, contentValues,
// SQLiteDatabase
// .CONFLICT_REPLACE) > 0);
// }
//
...
// Cursor cursor = mSQLiteDatabase.query(table, null, "key=?", new
// String[]{key}, null,
// null, null);
// if (cursor.moveToNext() && (cursor.getInt(cursor.getColumnIndex("is_read"))
// == value)) {
// isRead = true;
// }
// cursor.close();
...
// db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS,
// DBConfig.TABLE_GANKIO_DAY));
// db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS,
// DBConfig.TABLE_GANKIO_CUSTOM));
// }
//
// @Override
