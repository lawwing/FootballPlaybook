package cn.lawwing.lawwingnormalsdk.base.fragment;
...
import cn.lawwing.lawwingnormalsdk.base.IBaseFragment;
import cn.lawwing.lawwingnormalsdk.base.IBaseModel;
import cn.lawwing.lawwingnormalsdk.base.activity.BaseActivity;
        ...
        extends BaseCompatFragment implements IBaseFragment
{
    ...
    @Override
    public void startNewFragmentWithPop(
            @NonNull SupportFragment supportFragment)
    {
        startWithPop(supportFragment);
    }
    
    @Override
    public void startNewFragmentForResult(
            @NonNull SupportFragment supportFragment, int requestCode)
    {
        startForResult(supportFragment, requestCode);
    }
    
    @Override
    public void popToFragment(Class<?> targetFragmentClass,
    ...
    @Override
    public void startNewActivityForResult(@NonNull Class<?> clz, Bundle bundle,
            int requestCode)
    {
