package cn.lawwing.lawwingnormalsdk.widgets.headclip;
...
import static cn.lawwing.lawwingnormalsdk.utils.FileUtils.getRealFilePathFromUri;
...
import cn.lawwing.lawwingnormalsdk.utils.LogUtils;
...
public class ClipViewLayout extends RelativeLayout
{
    ...
    public void init(Context context, AttributeSet attrs)
    {
        ...
        // 获取裁剪框边框宽度，默认1dp
        int clipBorderWidth = array.getDimensionPixelSize(
        ...
        // 设置裁剪框类型
        clipView.setClipType(clipType == 1 ? ClipView.ClipType.CIRCLE
                : ClipView.ClipType.RECTANGLE);
        // 设置剪切框边框
    ...
    /**
     * 初始化图片 step 1: decode 出 720*1280 左右的照片 因为原图可能比较大 直接加载出来会OOM step 2: 将图片缩放
     * 移动到imageView 中间
     */
    ...
    public Bitmap clip()
    {
        ...
        try
        {
            cropBitmap = Bitmap.createBitmap(imageView.getDrawingCache(),
                    rect.left,
                    rect.top,
                    rect.width(),
                    rect.height());
