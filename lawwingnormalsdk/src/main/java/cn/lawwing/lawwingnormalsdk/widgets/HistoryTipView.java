...
public class HistoryTipView extends LinearLayout
{
    ...
    public void init(Context context)
    {
        ...
        setTextColor(ta.getColor(R.styleable.HistoryTipsView_android_textColor,
                Color.WHITE));
        setTextSize(
                ta.getDimension(R.styleable.HistoryTipsView_android_textSize,
                        12));
        setBackground(
                ta.getResourceId(R.styleable.HistoryTipsView_android_src, 0));
    }
