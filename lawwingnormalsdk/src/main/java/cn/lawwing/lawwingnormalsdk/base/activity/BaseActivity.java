package cn.lawwing.lawwingnormalsdk.base.activity;
...
import cn.lawwing.lawwingnormalsdk.AppManager;
...
import cn.lawwing.lawwingnormalsdk.utils.SpUtils;
import cn.lawwing.lawwingnormalsdk.utils.StatusBarUtils;
import cn.lawwing.lawwingnormalsdk.utils.ThemeUtils;
import cn.lawwing.lawwingnormalsdk.widgets.WaitPorgressDialog;
...
public abstract class BaseActivity extends SupportActivity
{
    ...
    {
        setTheme(ThemeUtils.themeArr[SpUtils.getThemeIndex(this)][SpUtils
                .getNightModel(this) ? 1 : 0]);
    ...
    public void startActivity(Class<?> clz)
    {
        ...
        if (isTransAnim)
            overridePendingTransition(R.anim.activity_start_zoom_in,
                    R.anim.activity_start_zoom_out);
    }
    ...
    public void finish()
    {
        super.finish();
        if (isTransAnim)
            overridePendingTransition(R.anim.activity_finish_trans_in,
