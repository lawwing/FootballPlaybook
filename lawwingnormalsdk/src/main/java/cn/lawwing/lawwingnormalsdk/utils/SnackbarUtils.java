...
public class SnackbarUtils
{
     ...
     * @return
     */
    public static Snackbar getShort(View view, String message, int messageColor,
            int backgroundColor)
    {
     ...
     * @return
     */
    public static Snackbar getLong(View view, String message, int messageColor,
            int backgroundColor)
    {
     ...
     * @return
     */
    public static Snackbar getIndefinite(View view, String message,
            int duration, int messageColor, int backgroundColor)
    {
